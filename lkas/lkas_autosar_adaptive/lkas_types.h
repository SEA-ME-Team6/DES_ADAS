...
#ifndef struct_codertarget_raspi_internal_RaspiTCPReceive_lkas_T
#define struct_codertarget_raspi_internal_RaspiTCPReceive_lkas_T

struct codertarget_raspi_internal_RaspiTCPReceive_lkas_T
{
  int32_t isInitialized;
...
#endif              // struct_codertarget_raspi_internal_RaspiTCPReceive_lkas_T
