...
#include "m_kSVo8V4Jk7WeMAjIJaeyx.hpp"
...
static emlrtRSInfo emlrtRSI{ 1,        /* lineNo */
  ...
  "/home/dahyun/Documents/MATLAB/SupportPackages/R2024a/toolbox/target/supportpackages/raspberrypi/+codertarget/+raspi/+internal/Ra"
  "spiTCPReceive.p"                    /* pathName */
};

static emlrtRSInfo b_emlrtRSI{ 1,      /* lineNo */
  "TCPReceive",                        /* fcnName */
  "/home/dahyun/Documents/MATLAB/SupportPackages/R2024a/toolbox/realtime/targets/linux/+codertarget/+linux/+blocks/TCPReceive.p"/* pathName */
};

static emlrtRSInfo c_emlrtRSI{ 1,      /* lineNo */
  "TCPReceive",                        /* fcnName */
  "/home/dahyun/Documents/MATLAB/SupportPackages/R2024a/toolbox/target/supportpackages/shared_linuxservices/+sharedlinux/TCPReceive"
  ".p"                                 /* pathName */
};

static emlrtRSInfo d_emlrtRSI{ 1,      /* lineNo */
  "System",                            /* fcnName */
  "/usr/local/MATLAB/R2024a/toolbox/shared/system/coder/+matlab/+system/+coder/System.p"/* pathName */
};

static emlrtRSInfo e_emlrtRSI{ 1,      /* lineNo */
  "SystemProp",                        /* fcnName */
  "/usr/local/MATLAB/R2024a/toolbox/shared/system/coder/+matlab/+system/+coder/SystemProp.p"/* pathName */
};

static emlrtRSInfo f_emlrtRSI{ 1,      /* lineNo */
  "SystemCore",                        /* fcnName */
  "/usr/local/MATLAB/R2024a/toolbox/shared/system/coder/+matlab/+system/+coder/SystemCore.p"/* pathName */
};
...
static emlrtMCInfo emlrtMCI{ 1,        /* lineNo */
  1,                                   /* colNo */
  "SystemCore",                        /* fName */
  "/usr/local/MATLAB/R2024a/toolbox/shared/system/coder/+matlab/+system/+coder/SystemCore.p"/* pName */
};

/* Function Declarations */
static void cgxe_mdl_start(InstanceStruct_kSVo8V4Jk7WeMAjIJaeyx *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_kSVo8V4Jk7WeMAjIJaeyx
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_kSVo8V4Jk7WeMAjIJaeyx
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_kSVo8V4Jk7WeMAjIJaeyx *moduleInstance);
static void cgxe_mdl_derivative(InstanceStruct_kSVo8V4Jk7WeMAjIJaeyx
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_kSVo8V4Jk7WeMAjIJaeyx *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_kSVo8V4Jk7WeMAjIJaeyx
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_kSVo8V4Jk7WeMAjIJaeyx
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_kSVo8V4Jk7WeMAjIJaeyx
...
static void SystemCore_checkTunablePropChange(const emlrtStack *sp,
  codertarget_raspi_internal_RaspiTCPReceive *obj);
static void mw__internal__call__reset(InstanceStruct_kSVo8V4Jk7WeMAjIJaeyx
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_kSVo8V4Jk7WeMAjIJaeyx
  *moduleInstance, const emlrtStack *sp, uint8_T *c_y0, int8_T *c_y1);
static const mxArray *emlrt_marshallOut(InstanceStruct_kSVo8V4Jk7WeMAjIJaeyx
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_kSVo8V4Jk7WeMAjIJaeyx *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_kSVo8V4Jk7WeMAjIJaeyx
...
static void cgxe_mdl_set_sim_state(InstanceStruct_kSVo8V4Jk7WeMAjIJaeyx
...
static boolean_T h_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_kSVo8V4Jk7WeMAjIJaeyx
  *moduleInstance);
...
static void cgxe_mdl_update(InstanceStruct_kSVo8V4Jk7WeMAjIJaeyx *)
{
}
...
static void cgxe_mdl_enable(InstanceStruct_kSVo8V4Jk7WeMAjIJaeyx *)
{
}
...
/* CGXE Glue Code */
static void mdlOutputs_kSVo8V4Jk7WeMAjIJaeyx(SimStruct *S, int_T tid)
{
  InstanceStruct_kSVo8V4Jk7WeMAjIJaeyx *moduleInstance =
    (InstanceStruct_kSVo8V4Jk7WeMAjIJaeyx *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_kSVo8V4Jk7WeMAjIJaeyx(SimStruct *S)
{
  InstanceStruct_kSVo8V4Jk7WeMAjIJaeyx *moduleInstance =
    (InstanceStruct_kSVo8V4Jk7WeMAjIJaeyx *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_kSVo8V4Jk7WeMAjIJaeyx(SimStruct *S, int_T tid)
{
  InstanceStruct_kSVo8V4Jk7WeMAjIJaeyx *moduleInstance =
    (InstanceStruct_kSVo8V4Jk7WeMAjIJaeyx *)cgxertGetRuntimeInstance(S);
...
static void mdlDerivatives_kSVo8V4Jk7WeMAjIJaeyx(SimStruct *S)
{
  InstanceStruct_kSVo8V4Jk7WeMAjIJaeyx *moduleInstance =
    (InstanceStruct_kSVo8V4Jk7WeMAjIJaeyx *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_kSVo8V4Jk7WeMAjIJaeyx(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_kSVo8V4Jk7WeMAjIJaeyx *moduleInstance =
    (InstanceStruct_kSVo8V4Jk7WeMAjIJaeyx *)cgxertGetRuntimeInstance(S);
...
static void setSimState_kSVo8V4Jk7WeMAjIJaeyx(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_kSVo8V4Jk7WeMAjIJaeyx *moduleInstance =
    (InstanceStruct_kSVo8V4Jk7WeMAjIJaeyx *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_kSVo8V4Jk7WeMAjIJaeyx(SimStruct *S)
{
  InstanceStruct_kSVo8V4Jk7WeMAjIJaeyx *moduleInstance =
    (InstanceStruct_kSVo8V4Jk7WeMAjIJaeyx *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_kSVo8V4Jk7WeMAjIJaeyx(SimStruct *S)
{
  InstanceStruct_kSVo8V4Jk7WeMAjIJaeyx *moduleInstance =
    (InstanceStruct_kSVo8V4Jk7WeMAjIJaeyx *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_kSVo8V4Jk7WeMAjIJaeyx(SimStruct *S)
{
  InstanceStruct_kSVo8V4Jk7WeMAjIJaeyx *moduleInstance =
    (InstanceStruct_kSVo8V4Jk7WeMAjIJaeyx *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_kSVo8V4Jk7WeMAjIJaeyx(SimStruct *S)
{
  InstanceStruct_kSVo8V4Jk7WeMAjIJaeyx *moduleInstance =
    (InstanceStruct_kSVo8V4Jk7WeMAjIJaeyx *)calloc(1, sizeof
    (InstanceStruct_kSVo8V4Jk7WeMAjIJaeyx));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_kSVo8V4Jk7WeMAjIJaeyx);
  ssSetmdlInitializeConditions(S, mdlInitialize_kSVo8V4Jk7WeMAjIJaeyx);
  ssSetmdlUpdate(S, mdlUpdate_kSVo8V4Jk7WeMAjIJaeyx);
  ssSetmdlDerivatives(S, mdlDerivatives_kSVo8V4Jk7WeMAjIJaeyx);
  ssSetmdlTerminate(S, mdlTerminate_kSVo8V4Jk7WeMAjIJaeyx);
  ssSetmdlEnable(S, mdlEnable_kSVo8V4Jk7WeMAjIJaeyx);
  ssSetmdlDisable(S, mdlDisable_kSVo8V4Jk7WeMAjIJaeyx);
...
static void mdlProcessParameters_kSVo8V4Jk7WeMAjIJaeyx(SimStruct *S)
{
}

void method_dispatcher_kSVo8V4Jk7WeMAjIJaeyx(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_kSVo8V4Jk7WeMAjIJaeyx(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_kSVo8V4Jk7WeMAjIJaeyx(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_kSVo8V4Jk7WeMAjIJaeyx(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_kSVo8V4Jk7WeMAjIJaeyx(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: kSVo8V4Jk7WeMAjIJaeyx.\n"
...
mxArray *cgxe_kSVo8V4Jk7WeMAjIJaeyx_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_kSVo8V4Jk7WeMAjIJaeyx_fallback_info(void)
{
